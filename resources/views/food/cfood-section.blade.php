...
<x-layout>
  <div class="container my-3">
    <div class="card" style="border:none;">
      <div class="row">
        <div class="col-md-4">
          <img src="/img/cfood.jpg" alt="" class="img-fluid rounded" style="height:300px;">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <div class="card-title fw-bold">ကြက်စာများ</div>
            <p class="card-text">
              မွေးမြူရေးလုပ်ငန်းရှင်များသည်စိန်ခေါ်မှုအပြည့်ရှိနေတဲ့ပတ်ဝန်းကျင်အနေအထားများမှာလုပ်ငန်းလုပ်ကိုင်လျက်ရှိနေကြပါသည်။
              တစ်ဖက်တွင်ထုတ်လုပ်မှုကုန်ကျစရိတ်ကိုလျှော့ချရန်အထူးပင်လိုအပ်လျက်ရှိနေပါသည်။
              အခြားတစ်ဖက်တွင်လည်းစားသုံးသူများအနေဖြင့်
              ဘေးအန္တရာယ်ကင်းရှင်းသော၊သန့်ရှင်းလတ်ဆတ်သော၊အရည်အသွေးမြင့်အသားများကိုရရှိရန်တောင်းဆိုမှုများလည်းမြင့်တက်လာလျက်ရှိနေပါသည်။
              ...
              ကျွန်ုပ်တို့မှကူညီဆောင်ရွက်ပေးလျက်ရှိနေပါသည်။မိတ်ဆွေတို့ကြက်ခြံများအတွက် အစားအစာ၊ အဟာရဆိုင်ရာစီမံခန့်ခွဲမှုများနှင့်အခြားသော ရှု့ထောင့်ပေါင်းစုံမှလိုအပ်သောစီမံခန့်ခွဲမှုများအတွက်အမြဲကူညီဖို့အသင့်ရှိပါသည်။
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="dropdown mb-2 mt-2 text-center">  
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="/chicken_foods">အားလုံး</a></li>
  @foreach ($companies as $company)
  <li><a class="dropdown-item" href="/chicken_foods/?company={{$company->slug}}{{request('search')?'&search='.request('search') : ''}}">{{$company->name}}</a></li>
  @endforeach
    </ul>
  </div>
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 mb-4">
        <div class="card m-5 text-center overflow-hidden" style="width:18rem;border:none;">
          <img src="/storage/{{$chickenfood->image}}" class="card-img-top" alt="..." style="height:250px;width:250px;">
          <div class="card-body">
      ...
      @empty
      <p class="text-center">No chicken livestock food found.</p>
      @endforelse
      {{$chickenfoods->links()}}
    </div>
  </section>
