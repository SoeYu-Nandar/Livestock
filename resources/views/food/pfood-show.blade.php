  ...
  <div class="container my-3">
    <div class="card" style="border:none;">
      <div class="row">
        <div class="col-md-4">
          <!-- Image Thumbnail -->
          <img src="/storage/{{$pigfood->image}}" class="img-fluid rounded" alt="Thumbnail"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
              <div class="modal-content">
                <div class="modal-body p-0">
                  <img src="/storage/{{$pigfood->image}}" class="w-100" alt="Full Image">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p class="card-text">ဈေးနှုန်း - {{$pigfood->price}} ကျပ်</p>
            <p class="card-text">အလေးချိန် - {{$pigfood->weight}} ကီလို</p>
            <p class="card-text">ကုမ္ပဏီအမည် - {{$pigfood->company->name}} Co.Ltd</p>
